// ⚠ KEEP IN SYNC with server/src/config/gamification.ts — levels/badges/points must match exactly.
// The server is authoritative for awarding points; this copy is display-only.
