              ...
              return (
                <li key={conv.id} className="group relative">
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 p-1 rounded text-slate-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-950 transition-all md:opacity-0 md:group-hover:opacity-100"
                  >
