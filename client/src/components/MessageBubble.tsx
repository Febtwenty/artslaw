  ...
  return (
    <div className="flex flex-col md:flex-row md:gap-3 md:items-start">
      ...
      <div className="flex items-center gap-2 mb-2 md:mb-0 md:block">
        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center md:mt-0.5">
          <span className="text-indigo-600 text-xs font-semibold">A</span>
        </div>
        <span className="text-indigo-500 text-xs font-medium md:hidden">ArtSlaw</span>
      </div>

      {/* Message content */}
      <div className="flex-1 min-w-0">
        <span className="hidden md:block text-indigo-500 text-xs font-medium mb-2">
          ArtSlaw
        </span>
